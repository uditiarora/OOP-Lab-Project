...
import oops.data.model.MailServerInfo;
import oops.database.DataHelper;
import oops.database.DatabaseHandler;
import oops.ui.notifoverdue.emailsender.EmailSenderController;
import oops.ui.settings.Preferences;
...
public class OverdueNotificationController implements Initializable {
    ...
    private void handleSendNotificationAction(ActionEvent event) {
        ...
        Object controller = LibraryAssistantUtil.loadWindow(getClass().getResource("/oops/ui/notifoverdue/emailsender/email_sender.fxml"), "Notify Overdue", null);
        if (controller != null) {
