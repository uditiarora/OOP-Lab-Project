...
import oops.database.export.DatabaseExporter;
import oops.ui.mail.TestMailController;
...
public class SettingsController implements Initializable {
    ...
    private void handleTestMailAction(ActionEvent event) {
        ...
        if (mailServerInfo != null) {
            TestMailController controller = (TestMailController) LibraryAssistantUtil.loadWindow(getClass().getResource("/oops/ui/mail/test_mail.fxml"), "Test Email", null);
